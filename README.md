...
![\dfrac{\mathrm{#~of~correct~predictions}}{\mathrm{Total~#~of~predictions}}](https://latex.codecogs.com/gif.latex?\dfrac{\mathrm{#~of~correct~predictions}}{\mathrm{Total~#~of~predictions}})
